...
vector<vector<Rect>> slidingWindowDetection(vector<Mat> imagePyramid, Size window, double scaling, int stride, bool nonMaxSuppression, const struct model* SVMModel);
